 ...
 *     as the on-disk file backend in example 22
 ...
 *      php index.php
 *
 * Listens on the same SMTP and IMAP ports as example 22
 * (2525 / 1143) -- if you have example 22 running, kill it
 ...
 * The same MailSite hooks shown in example 22 still work
...
/*
    ...
    pattern as example 22; see that file for cross-platform
    notes. The webui is reached at http://localhost:8080/
    -- the conventional port for atto example webuis. If
    you have example 22 (or any other example webui)
