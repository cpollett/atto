 ...
 *     as the on-disk file backend in example 23
 ...
 *      php index.php
 *
 * Listens on the same SMTP and IMAP ports as example 23
 * (2525 / 1143) -- if you have example 23 running, kill it
 ...
 * The same MailSite hooks shown in example 23 still work
...
/*
    ...
    pattern as example 23; see that file for cross-platform
    notes. The webui is reached at http://localhost:8080/
    -- the conventional port for atto example webuis. If
    you have example 23 (or any other example webui)
